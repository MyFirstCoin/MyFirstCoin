...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight < 10519200) // 1 block reward
        nSubsidy = 1;
...
static const int64 nTargetTimespan = .1 * 24 * 60 * 60; // MyFirstCoin: 0.1 days
static const int64 nTargetSpacing = 120; // MyFirstCoin: 2 min
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal MyFirstCoin miner
